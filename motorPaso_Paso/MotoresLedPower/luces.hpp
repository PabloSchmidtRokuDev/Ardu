...
flag = false;    
  ...
  if (LED_R_Current_value2 != LED_R_Brillo_value2) {
    if (LED_R_Current_value2 < LED_R_Brillo_value2) LED_R_Current_value2++;
    else LED_R_Current_value2--;
    flag = false;
  }

  if (LED_G_Current_value2 != LED_G_Brillo_value2) {
    if (LED_G_Current_value2 < LED_G_Brillo_value2) LED_G_Current_value2++;
    else LED_G_Current_value2--;
    flag = false;
  }

  if (LED_B_Current_value2 != LED_B_Brillo_value2) {
    if (LED_B_Current_value2 < LED_B_Brillo_value2) LED_B_Current_value2++;
    else LED_B_Current_value2--;
    flag = false;
  }
  if (LED_W_Current_value2 != LED_W_Brillo_value2) {
    if (LED_W_Current_value2 < LED_W_Brillo_value2) LED_W_Current_value2++;
    else LED_W_Current_value2--;
    flag = false;
  }
...
if (flag == false){
  ...
  analogWrite(pin_W, LED_G_Current_value);

  analogWrite(pin_R2, LED_R_Current_value2);
  analogWrite(pin_B2, LED_B_Current_value2);
  analogWrite(pin_G2, LED_G_Current_value2);
  analogWrite(pin_W2, LED_G_Current_value2);
