...
void setLedColor() {
  ...
  if (LED_R_Current_value != LED_R_Brillo_value || LED_G_Current_value != LED_G_Brillo_value || LED_B_Current_value != LED_B_Brillo_value) {
    //cTiempo1 = millis();
...
LED_R_Current_value = LED_R_Brillo_value;
LED_G_Current_value = LED_G_Brillo_value;
LED_B_Current_value = LED_B_Brillo_value;
