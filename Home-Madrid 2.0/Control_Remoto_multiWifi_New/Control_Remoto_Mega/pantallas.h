...
Adafruit_GFX_Button btn_amb_prev, btn_amb_next, btn_efecto_prev, btn_efecto_next, btn_br_menos, btn_br_mas;
...
void msgXY(int x, int y, int sz, const GFXfont *f, const char *msg) {
  int16_t x1, y1;
  uint16_t wid, ht;
  tft.setFont(f);
  tft.setCursor(x, y);
...
void drawMainScreen() {
  ...
  showmsgXY(20, 60, 1, &FreeSans9pt7b, "Ambiente");
  showmsgXY(20, 130, 1, &FreeSans9pt7b, "Efecto");

  tft.drawFastHLine(0, 180 + 2, tft.width(), WHITE);

  msgXY(65, 200, 1, NULL, "Brillo");
  msgXY(65, 210, 1, NULL, "100%");
  tft.setFont(NULL);

  tft.setFont(&FreeSans9pt7b);
  tft.setTextSize(2);

tft.fillRect(80, 90,250, 40, WHITE);


  btn_PowerAll.initButton(&tft, 250, 210, 110, 50, WHITE, RED, YELLOW, "Power", 1, 1);
  //btn_remotePower.initButton(&tft, 180, 50, 110, 50, WHITE, RED, YELLOW, "Control off", 1);

  btn_Habitacion.initButton(&tft, 60, 25, 90, 40, WHITE, RED, YELLOW, "Cuarto", 1);
  btn_Living.initButton(&tft, 160, 25, 90, 40, WHITE, RED, YELLOW, "Living", 1);
  btn_Barras.initButton(&tft, 260, 25, 90, 40, WHITE, RED, YELLOW, "Barras", 1);

  btn_amb_prev.initButton(&tft, 30, 90, 50, 40, WHITE, GREEN, BLACK, "<", 1);
  btn_amb_next.initButton(&tft, 290, 90, 50, 40, WHITE, GREEN, BLACK, ">", 1);

  btn_efecto_prev.initButton(&tft, 30, 155, 50, 40, WHITE, GREEN, BLACK, "<", 1);
  btn_efecto_next.initButton(&tft, 290, 155, 50, 40, WHITE, GREEN, BLACK, ">", 1);

  btn_br_menos.initButton(&tft, 30, 210, 50, 40, WHITE, GREEN, BLACK, "-", 1);
  btn_br_mas.initButton(&tft, 135, 210, 50, 40, WHITE, GREEN, BLACK, "+", 1);


  btn_Habitacion.drawButton(false);
  btn_Living.drawButton(false);
  btn_Barras.drawButton(false);
  btn_amb_prev.drawButton(false);
  btn_amb_next.drawButton(false);
  btn_efecto_prev.drawButton(false);
  btn_efecto_next.drawButton(false);
  btn_br_menos.drawButton(false);
  btn_br_mas.drawButton(false);
