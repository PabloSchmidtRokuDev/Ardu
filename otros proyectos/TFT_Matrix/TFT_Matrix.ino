...
#include "A_DOWN_100.h"
#include "A_LEFT_100.h"
#include "A_RIGHT_100.h"
#include "A_UP_100.h"
...
void setup() {
  ...
  //  sprMatrix.createSprite(100, 200);
  //  sprMatrix.fillScreen(TFT_BLACK);
  //  sprMatrix.setTextWrap(true);
  //  sprMatrix.setCursor(0, 0);
  //  sprMatrix.print("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum");
