...
<h2>Abriendo puerta!!! atencion... ten cuidado...</h2>

  <a href="http://devpablo.com/Home/LinkUnSoloUso.php?codigo=<?php echo $claveID; ?>">
    <button class="btn success">Volver</button>
  </a>
</body> </html>
