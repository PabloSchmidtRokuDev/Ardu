...
?>
   ...
   <p class="text-white mb-5">Las siguientes opciones abren las diferentes puertas. Utilice las opciones cuando este delante de la puerta</p>
    ...
    ?>
              ...
              <a class="btn btn-rounded-icon" href="http://devpablo.com/Home/OpenDoorUKey.php?Exterior=1&claveID=<?php echo $claveID; ?>">Enstrada principal del edificio</a>
    ...
    ?>
              <li class="list-inline-item">
              <a class="btn btn-rounded-icon" href="http://devpablo.com/Home/OpenDoorUKey.php?Medio=1&claveID=<?php echo $claveID; ?>">Segunda puerta - Acceso al corredor</a>
              </li>
