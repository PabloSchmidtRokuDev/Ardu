...
int TURNSPEED=50  ;
SoftwareSerial BTserial(3, 4); // SRX | STX
...
void setup()
{
  ...
  BTserial.begin(9600);  //In order to fit the Bluetooth module's default baud rate, only 9600
  Serial.println("BTserial started at 9600");
  Serial.print("setup completo... start ");
}
...
void do_Uart_Tick()
{
  ...
  { //data ready
    ...
    //Serial.println("data del blue...");
    //Serial.write(buffUART);
  ...
  if (Uart_Date != 0) 
  {
    Serial.print("Serial data recibe");
