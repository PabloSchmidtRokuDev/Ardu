...
MFRC522::MIFARE_Key keyA = {keyByte: {0xC7, 0x2F, 0x56, 0xB2, 0x0C, 0x08}};
MFRC522::MIFARE_Key keyB = {keyByte: {0x64, 0x65, 0x66, 0x67, 0x68, 0x69}};

// Nuevas claves de cifrado

MFRC522::MIFARE_Key nuevaKeyA = {keyByte: {0x69, 0x53, 0x7F, 0x89, 0xCC, 0x08}};
MFRC522::MIFARE_Key nuevaKeyB = {keyByte: {0x64, 0x65, 0x66, 0x67, 0x68, 0x69}};
