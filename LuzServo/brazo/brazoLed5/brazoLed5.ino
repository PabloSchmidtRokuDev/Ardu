...
void setup() {
  ...
  servo_base.attach(pin_servo_base, 500, 2500);
  servo_flexionn1.attach(pin_servo_flexionn1, 500, 2500);
  servo_flexionn2.attach(pin_servo_flexionn2, 500, 2500);
  servo_Lampara.attach(pin_servo_Lampara, 500, 2500);
