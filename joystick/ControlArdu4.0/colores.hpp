...
void colorX::setSelect(bool _select) {
  ...
  tft.fillRect(16 * posX + 4, 16 * posY + 4, 15, 15, colorHEX);
  if (select == true) {
    tft.drawRect(16 * posX + 4, 16 * posY + 4, 15, 15, TFT_WHITE);
    tft.drawRect(16 * posX + 5, 16 * posY + 5, 13, 13, TFT_RED);
    tft.drawRect(16 * posX + 6, 16 * posY + 6, 11, 11, TFT_BLACK);
    Serial.print(" >selected< ");
  } else {
    Serial.print(" <un selected> ");
  }
