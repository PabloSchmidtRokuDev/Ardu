...
int LED_Pins[4] = { 14, 12, 27, 26 };
int LED_Brillo_value[4] = { 0, 0, 0, 0 };
int LED_Current_value[4] = { 0, 0, 0, 0 };
int LED_Pulse_value[4] = { 0, 0, 0, 0 };

int LED2_Pins[4] = { 17, 19, 18, 5 };
int LED2_Brillo_value[4] = { 0, 0, 0, 0 };
int LED2_Current_value[4] = { 0, 0, 0, 0 };
int LED2_Pulse_value[4] = { 0, 0, 0, 0 };
...
void setup() {
  ...
  for (int i = 0; i < 4; i++) { pinMode(LED2_Pins[i], OUTPUT); }
  ...
  //     LED_Brillo_value[i] = 0;
  //     LED_Current_value[i] = 0;
  //     analogWrite(LED_Pins[i], LED_Current_value[i]);
  //   }

  //   if (LED2_Current_value[i] != LED2_Brillo_value[i]) {
  //     LED2_Brillo_value[i] = 0;
  //     LED2_Current_value[i] = 0;
  //     analogWrite(LED2_Pins[i], LED2_Current_value[i]);
  //   }
  // }

  
  // delay(5000);
  // Serial.println("innicio de test 1");

  //   analogWrite(LED_Pins[0], 50);
  //   delay(5000);

  //  analogWrite(LED_Pins[0], 0);
  //   analogWrite(LED_Pins[1], 50);
  //   delay(5000);

  //  analogWrite(LED_Pins[1], 0);
  //   analogWrite(LED_Pins[2], 50);
  //   delay(5000);

  //  analogWrite(LED_Pins[2], 0);
  //   analogWrite(LED_Pins[3], 50);
  //   delay(5000);
  ...
  // Serial.println("innicio de test2");

  //   analogWrite(LED2_Pins[0], 50);
  //   delay(5000);

  //  analogWrite(LED2_Pins[0], 0);
  //   analogWrite(LED2_Pins[1], 50);
  //   delay(5000);

  //  analogWrite(LED2_Pins[1], 0);
  //   analogWrite(LED2_Pins[2], 50);
  //   delay(5000);

  //  analogWrite(LED2_Pins[2], 0);
  //   analogWrite(LED2_Pins[3], 50);
  //   delay(5000);
