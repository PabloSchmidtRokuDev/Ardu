...
//const int TS_LEFT=894,TS_RT=185,TS_TOP=924,TS_BOT=167;

//*** COPY-PASTE from Serial Terminal:
const int XP=7,XM=A1,YP=A2,YM=6; //480x320 ID=0x9486
const int TS_LEFT=934,TS_RT=190,TS_TOP=193,TS_BOT=300;
/*
...
void checkBtnMain() {
  ...
  if (btn_Barras.justReleased()) { btn_Barras.drawButton(false); }
   ...
   if (btn_remotePower.justPressed()) {  
     btn_remotePower.drawButton(true);  
     delay(500); 


     //executeFunction(destino_Habitacion, "HEX", "AB54FF00");
      }
